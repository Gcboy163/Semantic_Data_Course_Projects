...
ask_question_to_book("How to stop a plague?", verbose=True)
ask_question_to_book("How does the world look like after a plague?")
ask_question_to_book("What are the symptoms of being infected?")
ask_question_to_book("Are humans good creatures?")